...
<body>
    ...
    <div class="mt-3 form-container mx-auto border shadow-lg">
        <p class="title c-s">Login</p>
        <form class="form" action="{{route('login')}}" method="POST">
            ...
            <div class="input-group">
                ...
                <input type="email" name="email" id="email" placeholder="Enetr Email">
            </div>
            @error('password')
                <div class="alert alert-danger" role="alert" style="padding: 2px 5px; margin-top:10px;margin-bottom:-6px">
                    {{ $message }}
        ...
        <p class="signup">Don't have an account?
            <a rel="noopener noreferrer" href="/registration" class="">Sign up</a>
        </p>
    </div>
</body>
