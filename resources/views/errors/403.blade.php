...
<body>
    ...
    <h1>You Don't Have Permissions to do that</h1>
    <h2>Going <a href="{{ route('dashboard') }}">Home</a> in ..... <span id="countdown">10</span> Seconds </h2>
</body>
<script>
    ...
    let countdown = 10;
        ...
        const interval = setInterval(() => {
            ...
            if (countdown <= 0) {
                ...
                window.location.href = '{{ url('/dashboard') }}'; // Change this to your dashboard URL
            }
        }, 1000);
</script>
